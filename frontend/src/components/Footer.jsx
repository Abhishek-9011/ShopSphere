      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-indigo-600">ShopSphere</h2>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mt-0.5 mr-3 text-indigo-500" />
                <span>123 Shop Street, Retail City, RC 10001</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-3 text-indigo-500" />
                <a href="mailto:info@shopsphere.com" className="hover:text-indigo-600">
                  info@shopsphere.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-3 text-indigo-500" />
                <a href="tel:+11234567890" className="hover:text-indigo-600">
                  +1 (123) 456-7890
                </a>
              </li>
            </ul>
